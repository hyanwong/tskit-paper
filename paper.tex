...
simulator in \citesupp{kelleher2016efficient}. [Mention the
...
in \citesupp{kelleher2018efficient}, and the columnar tables API.
...
is now used in varied applications~\citesupp{haller2018tree}.

The genealogical nearest neighbourhs (GNN) statisic was introduced
in~\citesupp{kelleher2019inferring}.

The general API for computing population genetics statistics
was introduced in~\citesupp{ralph2020efficiently}, which also introduced
...
[Summarise also: \citesupp{fritze2026forest}, \citesupp{lehmann2026on}
and \citesupp{lee2026genetic}. Although Lee et al 2026 doesn't describe
