...
data model~\cite{kelleher2016efficient,kelleher2018efficient}
and its formalisation as a general ARG represention~\cite{wong2024general},
the 1.0 release marks the maturity of tskit as a stable software library
and data model for scalable ARG analysis (see Supplementary Information).
...
to grow. As tskit is applied to a wider range of biological applications,
future developement is likely to address complexities such as encoding
multiple chromosomes and structural variants.
